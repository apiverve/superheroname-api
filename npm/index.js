...
class superheronameWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/superheroname');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/superheroname';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"style":{"type":"string","required":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/superheroname`);
        }
    }
...
module.exports = superheronameWrapper;
