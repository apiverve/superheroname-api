# Superhero Name Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:superheroname-api:1.1.14'
}
```
...
```java
import com.apiverve.superheroname.SuperheroNameGeneratorAPIClient;
import com.apiverve.superheroname.APIResponse;
import com.apiverve.superheroname.APIException;

// Initialize the client
SuperheroNameGeneratorAPIClient client = new SuperheroNameGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("style", "dark");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/superheroname](https://docs.apiverve.com/ref/superheroname)
...
- **Documentation:** [https://docs.apiverve.com/ref/superheroname](https://docs.apiverve.com/ref/superheroname)
- **Issues:** [GitHub Issues](https://github.com/apiverve/superheroname-api/issues)
