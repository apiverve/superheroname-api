// Package superheroname provides a Go client for the Superhero Name Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/superheroname?utm_source=go&utm_medium=readme
package superheroname
...
const (
	baseURL        = "https://api.apiverve.com/v1/superheroname"
	defaultTimeout = 30 * time.Second
)

// Client is the Superhero Name Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Superhero Name Generator API client.
...
// Execute makes a request to the Superhero Name Generator API with typed parameters.
//
